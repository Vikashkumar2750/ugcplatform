...
export default function InsightsDashboard() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-24">
      ...
      {/* Tab Content Areas */}
      <div className="mt-6">
        {activeTab === "overview" && <OverviewTab timeRange={timeRange} accountId={selectedAccount?.platform_user_id} platform={selectedAccount?.platform} />}
        {activeTab === "audience" && <AudienceTab accountId={selectedAccount?.platform_user_id} platform={selectedAccount?.platform} />}
        {activeTab === "content" && <ContentTab timeRange={timeRange} accountId={selectedAccount?.platform_user_id} platform={selectedAccount?.platform} />}
        {activeTab === "ai" && <AIInsightsTab accountId={selectedAccount?.platform_user_id} platform={selectedAccount?.platform} />}
      </div>
    </div>
  );
}
