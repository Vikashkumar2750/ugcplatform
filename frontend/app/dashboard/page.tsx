      ...
      {!hasKeys && (
        <div className="flex items-center gap-3 p-4 rounded-xl border border-amber-400/30 bg-amber-400/8">
          ...
          <div className="flex-1">
            <p className="text-sm font-medium">AI + Analysis API keys set nahi hain</p>
            <p className="text-xs text-muted-foreground">Koi bhi ek AI key (Claude/Gemini/OpenAI) aur ek Analysis key add karo</p>
          </div>
