...
export async function POST(req: NextRequest) {
  ...
  const { name, type, platform = "instagram", keywords, replyText, replyTexts, dmMessage, dmMessages, dmLink, dmLinkLabel, delay, matchType, mediaId, mediaThumb, mediaCaption, mediaIds, actionsEnabled, hide, account_id, requireFollow, followPromptMessages, followUpEnabled, followUpDelay, followUpMessages, notFollowingMessages, doneButtonText } = body;
  ...
  const action_config: any = {
    ...
    done_button_text: doneButtonText || undefined,
  };
