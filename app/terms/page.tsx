      ...
      <div className="min-h-screen bg-background py-16 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-8 text-muted-foreground leading-relaxed text-sm">
            ...
            <section>
              <h2 className="font-heading text-lg font-bold text-foreground mb-3">10. Governing Law</h2>
              <p>These Terms are governed by the laws of India. Any disputes shall be subject to the jurisdiction of courts in India.</p>
            </section>

            <section>
              <h2 className="font-heading text-lg font-bold text-foreground mb-3">11. Contact</h2>
              <p>
