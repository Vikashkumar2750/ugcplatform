      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-sm dark:prose-invert max-w-none space-y-8 text-muted-foreground leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1 mt-2">
              <li>All automated DMs include an opt-out option ("Reply STOP to unsubscribe")</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1 mt-2">
              ...
              <li><strong className="text-foreground">Render / Vercel</strong> — hosting providers</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              To delete your data, contact us at <a href="mailto:privacy@contentiq.app" className="text-amber-600 dark:text-amber-400 hover:underline">privacy@contentiq.app</a> or use the account deletion option in Settings.
              Facebook users can also request data deletion directly through{" "}
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:privacy@contentiq.app" className="text-amber-600 dark:text-amber-400 hover:underline">privacy@contentiq.app</a>
            </p>
          </section>
        </div>
      </div>
