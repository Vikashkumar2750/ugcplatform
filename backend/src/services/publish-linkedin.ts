...
async function uploadLinkedinImage(authorUrn: string, mediaUrl: string, token: string): Promise<string> {
  // 1. Initialize upload
...
async function uploadLinkedinVideo(authorUrn: string, mediaUrl: string, token: string): Promise<string> {
  // 1. Initialize upload
...
export async function publishLinkedinPost(post: any, token: string) {
